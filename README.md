...
| -       | 代码质量管理平台       | 集成不同的测试工具，代码分析工具，持续集成工具等 | [SonarQube](https://github.com/SonarSource/sonarqube) + [SonarLint](https://marketplace.visualstudio.com/items?itemName=SonarSource.sonarlint-vscode) | -                                                            |
